...
public class GATx {
    ...
    private static int estimateElementsSize(final Transaction tx, final Network2 network2) {
        if (!network2.isElements())
            return 0;
    ...
    public static int getTxVSize(final Transaction tx, final Network2 network) {
        final int vSize;
