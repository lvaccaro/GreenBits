...
public class HDKey {
    ...
    public static DeterministicKey[] getGAPublicKeys(final int subAccount, final Integer pointer, final Network2 network) {
        final DeterministicKey[] ret = new DeterministicKey[2];
    ...
    private static DeterministicKey getServerKeyImpl(final int subAccount, final Network2 network) {
