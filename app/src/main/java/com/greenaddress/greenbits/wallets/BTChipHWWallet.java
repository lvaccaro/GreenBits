...
public class BTChipHWWallet extends HWWallet {
    ...
    private BTChipHWWallet(final BTChipDongle dongle, final String pin, final List<Integer> addrn, final Network2 network) {
        mDongle = dongle;
        mPin = pin;
        mAddrn = addrn;
        mNetwork = network;
    ...
    public BTChipHWWallet(final BTChipDongle dongle, final Network2 network) {
        this(dongle, "0000", new LinkedList<Integer>(), network);
    }

    private BTChipHWWallet(final BTChipTransport transport, final String pin, final Network2 network) {
    ...
    public BTChipHWWallet(final BTChipTransport transport, final Network2 network) {
        this(transport, null, network);
    }

    public BTChipHWWallet(final BTChipTransport transport, final String pin, final SettableFuture<Integer> remainingAttemptsFuture, final Network2 network) {
